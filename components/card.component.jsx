...
const Card = ({profile_image,small,tags="#test#test#test",description,likes=32,username,imageUrl="https://images.unsplash.com/photo-1640521515233-f1fa3f600e31?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"})=>(
    <div className="card">
        <div className="card__header">
            <div className="image-wrapper">
                <Image  className="card__header-image" src={profile_image.medium ||null} width={40} height={40} alt={"profile image"} />
            </div>
